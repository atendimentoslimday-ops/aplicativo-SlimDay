...
const dailyMessages: DailyMessage[] = [
  ...
  { title: "Pequenas vitórias acumulam", body: "Cada etapa conclída fortalece sua confiança e facilita o próximo passo." },
      ...
      <div className="rounded-3xl border bg-white p-5 space-y-4">
        ...
        <div>
          ...
          <Select value={feedbackType} onValueChange={setFeedbackType}>
            ...
            <SelectContent>
              <SelectItem value="sugestao">Â­Æ’Ã†í Sugestão de melhoria</SelectItem>
              <SelectItem value="ideia">ðŸŒŸ Nova ideia</SelectItem>
              <SelectItem value="problema">ðŸª² Algo não funcionou</SelectItem>
              <SelectItem value="elogio">ðŸ’• Elogio</SelectItem>
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder="Conte pra gente o que você gostaria de ver no app, o que pode melhorar ou qualquer coisa que queira compartilhar ðŸŒˆ"
            value={feedbackMsg}
        ...
        {sent ? (
          <div className="rounded-2xl bg-emerald-50 p-4 text-center">
            <div className="text-lg font-bold text-emerald-700">Recebemos! ðŸ’•</div>
...
const phaseTreats: Record<CyclePhase, { titulo: string; descricao: string; receita?: RecipeDetail }[]> = {
  ...
  fértil: [
    { titulo: "Maçàassada com canela", descricao: "Doce simples e controlado para um lanche mais leve.", receita: { ingredientes: ["1 maçã", "Canela em pó a gosto", "1 colher de chá de mel (opcional)", "Cravo (opcional)"], preparo: ["Retire o miolo da maçàsem cortar a base.", "Polvilhe canela por dentro e por fora.", "Adicione mel e cravo se desejar.", "Asse no forno a 180Â°C por 25-30 min.", "Sirva morna."] } },
...
const tutorialMap: Record<string, string[]> = {
  ...
  "V-ups": ["Deite-se de costas com pernas e braços esticados.", "Suba o tronco e as pernas ao mesmo tempo tentando tocar os pés.", "Desça devagar voltando Ã  posição inicial."],
...
const exerciseMeta: Record<string, Partial<PlanItem>> = {
  "Finisher SlimDay": { dificuldade: "intenso", cuidado: "Feche forte, mas sem sacrificar a execução.", explicacaoSimples: "â”œÃ« o bloco final para terminar com sensação de missão cumprida.", youtubeId: "TU8QYVW0gDU" },
  // Novos Iniciante
  "Elevação pélvica": { dificuldade: "leve", cuidado: "Não force a lombar, suba usando os glúteos.", explicacaoSimples: "â”œÃ« levantar o quadril do chão e apertar o bumbum.", youtubeId: "wPM8icD6st0" },
  "Prancha de joelhos": { dificuldade: "leve", cuidado: "Mantenha o pescoço alinhado com a coluna.", explicacaoSimples: "â”œÃ« ficar paradinha apoiada nos braços e joelhos.", youtubeId: "6I2In2_S7m0" },
  "Polichinelo adaptado": { dificuldade: "leve", cuidado: "Se sentir dor no ombro, não suba os braços até o topo.", explicacaoSimples: "â”œÃ« o polichinelo sem pulo, um passo de cada vez.", youtubeId: "lV5a4IueVjE" },
  "4 apoios (Glúteos)": { dificuldade: "leve", cuidado: "Não deixe a barriga cair, mantenha firme.", explicacaoSimples: "â”œÃ« chutar o teto estando de joelhos no chão.", youtubeId: "vN_j_2a2S7o" },
  "Mobilidade de escápulas": { dificuldade: "leve", cuidado: "Mova apenas os ombros, não os braços.", explicacaoSimples: "â”œÃ« 'afundar' e 'empurrar' o peito para soltar os ombros.", youtubeId: "aclHkVaku9U" },
  // Novos Intermediário
  "Mountain Climber": { dificuldade: "moderado", cuidado: "Não eleve muito o quadril, mantenha-o baixo.", explicacaoSimples: "â”œÃ« como se estivesse subindo uma montanha no chão.", youtubeId: "nmwgirgXLYM" },
  "Tríceps no banco": { dificuldade: "moderado", cuidado: "Mantenha as costas próximas ao banco.", explicacaoSimples: "â”œÃ« descer e subir usando a força do 'tchau'.", youtubeId: "6kALZHewig4" },
  "Stiff": { dificuldade: "moderado", cuidado: "Mantenha a coluna reta o tempo todo.", explicacaoSimples: "â”œÃ« descer o corpo resto para alongar atrás das pernas.", youtubeId: "HML6f35U_f4" },
  "Prancha Lateral": { dificuldade: "moderado", cuidado: "Não deixe o quadril cair em direção ao chão.", explicacaoSimples: "â”œÃ« ficar de ladinho tirando o corpo do chão.", youtubeId: "pSHjTRCQxIw" },
  "Agachamento Sumô": { dificuldade: "moderado", cuidado: "Mantenha os joelhos na direção dos dedos dos pés.", explicacaoSimples: "â”œÃ« o agachamento com as pernas mais abertas.", youtubeId: "aclHkVaku9U" },
  "Remada alta": { dificuldade: "moderado", cuidado: "Não levante os ombros até as orelhas.", explicacaoSimples: "â”œÃ« puxar o peso até o queixo como um remador.", youtubeId: "S8_X9QpZp38" },
  // Novos Avançado
  ...
  "Prancha sobe e desce": { dificuldade: "intenso", cuidado: "Mantenha o quadril o mais parado possível.", explicacaoSimples: "â”œÃ« revezar entre apoiar as mãos e os cotovelos.", youtubeId: "pSHjTRCQxIw" },
};
...
function buildWorkoutPlan(profile: Profile): PlanItem[] {
  ...
  const pools = {
    ...
    intermediate: [
      ["Aquecimento dinâ”œómico", "Corpo pronto para treinar com mais ritmo."],
...
function getCongratsMessage(count: number) {
  if (count < 3) return "Boa! Cada etapa conclída fortalece sua nova rotina.";
              ...
              <Card className="rounded-[40px] border-none shadow-2xl p-10 bg-white">
                <CardContent className="p-0 space-y-8">
                  ...
                  <div className="grid gap-6">
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs uppercase tracking-widest font-bold text-slate-400 ml-1">â”œÃœltima Menstruação</Label>
              ...
              <Card className="rounded-[28px] border-emerald-100 shadow-xl">
                <CardContent className="p-6 md:p-8 space-y-5">
                  ...
                  <div className="grid gap-3">
                    {([["emagrecer", "ðŸ”¥ Emagrecer", "Perder peso de forma saudável e sustentável."], ["definir", "ðŸ’ª Definir", "Tonificar e ganhar mais definição muscular."], ["mais energia", "âš¡ Mais energia", "Ter mais disposição e ânimo no dia a dia."], ["criar constancia", "Â­Æ’Ã„Â» Criar constância", "Montar uma rotina e manter o hábito."]] as [Goal, string, string][]).map(([value, label, desc]) => (
                      <button
                        key={value}
            ...
            {step === "nivel" && (
              <Card className="rounded-[28px] border-sky-100 shadow-xl">
                <CardContent className="p-6 md:p-8 space-y-5">
                  ...
                  <div className="grid gap-3">
                    {([["iniciante", "ðŸŒ± Iniciante", "Nunca treinei ou treino pouco."], ["intermediaria", "ðŸŒ¿ Intermediária", "Tenho alguma experiência e constância."], ["avancada", "ðŸŒ² Avançada", "Treino regularmente e quero mais desafio."]] as [FitnessLevel, string, string][]).map(([value, label, desc]) => (
                      <button
                        key={value}
            ...
            {step === "rotina" && (
              <Card className="rounded-[28px] border-pink-100 shadow-xl">
                <CardContent className="p-6 md:p-8 space-y-5">
                  ...
                  <div className="grid gap-3">
                    {([["corrida", "âš¡ Muito corrida", "Tenho pouco tempo para tudo."], ["moderada", "Ã”Ã…â”‚ Moderada", "Consigo encaixar coisas com planejamento."], ["flexivel", "Â­Æ’Ã®Ã¨ Mais flexível", "Tenho flexibilidade para organizar o dia."]] as [RoutineStyle, string, string][]).map(([value, label, desc]) => (
                      <button
                        key={value}
            ...
            {step === "refeicao" && (
              <Card className="rounded-[28px] border-orange-100 shadow-xl">
                <CardContent className="p-6 md:p-8 space-y-5">
                  ...
                  <div className="grid gap-3">
                    {([["pratico", "ðŸš€ Prático", "Receitas rápidas e sem complicação."], ["equilibrado", "âš–ï¸ Equilibrado", "Variado e balanceado."], ["sem tempo", "â° Sem tempo", "O mais rápido possível."], ["caseiro", "ðŸ¡ Mais caseiro", "Gosto de cozinhar em casa."]] as [MealStyle, string, string][]).map(([value, label, desc]) => (
                      <button
                        key={value}
            ...
            {step === "done" && (
              <Card className="rounded-[28px] border-emerald-100 shadow-xl overflow-hidden">
                <div className="bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-700 p-8 text-white text-center">
                  ...
                  <h2 className="text-3xl font-black">Tudo pronto, {profile.nome}! Â­Æ’Ã„Ã«</h2>
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="rounded-2xl bg-rose-50 border border-rose-200 p-4 text-center">
                    <div className="text-sm font-bold text-rose-700">ðŸŽ Seu Calendário de Ciclo+ está pronto!</div>
            ...
            {step === "oferta" && (
              <Card className="rounded-[28px] border-rose-200 shadow-2xl overflow-hidden scale-105">
                <div className="bg-gradient-to-br from-rose-500 via-rose-600 to-pink-700 p-8 text-white text-center">
                  ...
                  <h2 className="text-3xl font-black">Oferta Especial de Boas-Vindas! âœ¨</h2>
                  <p className="mt-3 text-sm leading-6 opacity-90">Desbloqueie o acesso <strong className="font-black">VITALâ”œÃ¬CIO</strong> ao seu Calendário Menstrual Ciclo+ agora.</p>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="password" className="h-14 pl-12 rounded-2xl border-slate-100 bg-slate-50/50" value={senha} onChange={(e) => setSenha(e.target.value)} placeholder="Ã”Ã‡óÃ”Ã‡óÃ”Ã‡óÃ”Ã‡óÃ”Ã‡óÃ”Ã‡óÃ”Ã‡óÃ”Ã‡ó" />
                </div>
              </div>
              ...
              {ADMIN_EMAILS.includes(email.toLowerCase().trim()) && (
                <motion.div 
                  ...
                  className="space-y-2"
                >
                  <Label className="text-xs font-bold uppercase tracking-widest text-emerald-600 ml-1">Código de Desenvolvedor</Label>
                  <div className="relative">
...
function SlimDayApp() {
    ...
    setCompleted((prev) => {
      ...
      if (next) {
        ...
        setNotifications((prevN) => [
          buildNotification("Etapa conclída", `Você concluiu: ${title}`, "conquista"),
          ...prevN,
        ].slice(0, 8));
  ...
  const verifyAndRefreshCyclePurchase = useCallback(async () => {
    ...
    try {
      ...
      if (data) {
        ...
        // Compra ainda não confirmada pelo servidor â€” redireciona para a página de compra
        setCycleUnlocked(false);
      }
    } catch {
      // Silently handle â€” o estado permanece não desbloqueado por segurança
    }
  }, [userId]);
  ...
  useEffect(() => {
    ...
    const load = async (attempt = 0) => {
      ...
      // Mark profile as loaded (whether data found or not â€” enables quiz for new users)
    ...
    return (
      <div className="min-h-screen bg-[linear-gradient(180deg,#f3fff8_0%,#fffaf7_45%,#ffffff_100%)] px-4 flex items-center justify-center p-4">
        <Card className="max-w-md w-full rounded-[32px] border-emerald-100 shadow-2xl p-8 text-center bg-white relative overflow-hidden">
          ...
          >
            {appVerifyLoading ? "Verificando..." : <><BadgeCheck className="mr-2 h-5 w-5" /> Já comprei â€” verificar acesso</>}
          </button>
  ...
  return (
    <>
            ...
            >
              <Card className="rounded-[28px] border-rose-200 shadow-2xl overflow-hidden">
                <div className="bg-gradient-to-br from-rose-500 to-rose-700 p-6 text-white text-center">
                  ...
                  <h2 className="text-2xl font-black">Última chance! â°</h2>
      ...
      {/* Onboarding quiz overlay â€” never replaces the main app */}
      <AnimatePresence>
        {showOnboarding && (
          <motion.div
            initial={{ opacity: 0 }}
        ...
        <AnimatePresence>
          {savedToast && (
            <motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}
              ...
              Plano atualizado com sucesso âœ¨
            </motion.div>
          )}
        </AnimatePresence>
                ...
                <Card className="rounded-[28px] border-orange-100 shadow-lg">
                  <CardContent className="p-4 md:p-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-bold text-slate-900">Plano atualizado Ã”Â£ô</div>
                    ...
                    {mealPlan.map((item, index) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() => toggleCheck(item.id, item.titulo)}
                        >
                          {completed[item.id] ? "Sincronizado âœ…" : "Adicionar ao Planejamento"}
                        </Button>
                      </motion.div>
                    ))}
                  </div>
                          ...
                          <div className="p-5">
                            ...
                            {recipe.receita && (
                              <details className="mt-3">
                                <summary className="cursor-pointer text-sm font-semibold text-emerald-700">ðŸ“– Ver receita completa</summary>
                                <div className="mt-3 rounded-2xl border bg-orange-50 p-4 space-y-3">
                                  <div>
                                    <div className="font-semibold text-slate-800 text-sm">ðŸŒ¿ Ingredientes</div>
                                    <ul className="mt-1 list-disc pl-4 text-sm text-slate-600 space-y-1">
                                      {recipe.receita.ingredientes.map((ing, i) => <li key={i}>{ing}</li>)}
                                    </ul>
                                  </div>
                                  <div>
                                    <div className="font-semibold text-slate-800 text-sm">ðŸ‘¨â€ðŸ³ Modo de preparo</div>
                          ...
                          <div className="rounded-3xl border bg-white p-6">
                            {isTrialActive && !cycleUnlocked && (
                              <div className="mb-4 rounded-2xl bg-gradient-to-r from-emerald-50 to-green-50 border border-emerald-200 p-3">
                                <div className="text-xs font-semibold text-emerald-700">ðŸŽ Período de teste: {trialDaysLeft} dia{trialDaysLeft !== 1 ? "s" : ""} restante{trialDaysLeft !== 1 ? "s" : ""}</div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white p-6 rounded-[32px] border border-slate-50 shadow-sm flex flex-col items-center text-center">
                          ...
                          <span className="text-sm font-bold">8 Copos Ãgua</span>
                        </div>
                        <div className="bg-white p-6 rounded-[32px] border border-slate-50 shadow-sm flex flex-col items-center text-center">
