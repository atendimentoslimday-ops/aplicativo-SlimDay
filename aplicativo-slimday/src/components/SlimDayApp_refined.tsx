          ...
          <div className="mb-10 grid gap-6 lg:grid-cols-[1.4fr,0.6fr]">
            ...
            <Card className="rounded-[40px] border border-rose-100/70 shadow-premium overflow-hidden bg-white/95 backdrop-blur-sm group">
              <CardContent className="p-0 flex flex-col md:flex-row h-full">
                <div className="w-full md:w-1/3 bg-[linear-gradient(180deg,#42203f_0%,#241227_100%)] p-8 flex flex-col justify-between text-white relative overflow-hidden">
                          ...
                          <div className="grid gap-5 lg:grid-cols-[1.2fr,0.8fr]">
                            <div className="space-y-4">
                              <Card className="rounded-[36px] border border-slate-200 bg-white p-5 md:p-6 shadow-[0_20px_60px_rgba(15,23,42,0.06)]">
                                ...
                                <div className="mt-3">
                                  <span className="inline-flex rounded-full bg-emerald-100 px-4 py-2 text-xs font-semibold text-emerald-700">Hoje</span>
                                </div>
                                ...
                                <div className="mt-4 rounded-[24px] border border-rose-100 bg-rose-50/60 p-4">
                                  <div className="text-[11px] font-bold uppercase tracking-[0.22em] text-rose-400">Dias de menstruação</div>
                                  <div className="mt-2 flex items-center gap-3">
                                    <input type="number" className="h-12 w-28 rounded-[18px] border border-rose-100 bg-white px-4 text-base text-slate-700 outline-none transition focus:border-rose-300 focus:ring-4 focus:ring-rose-100" value={profile.duracaoMenstruacao || "5"} onChange={(e) => updateProfile("duracaoMenstruacao", e.target.value)} placeholder="5" />
                                    <p className="text-sm leading-6 text-slate-600">Ajuste aqui a quantidade média de dias para deixar a previsão mais próxima da sua realidade.</p>
                                  </div>
                                </div>
                              </Card>
